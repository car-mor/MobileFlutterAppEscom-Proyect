...
class SustentabilidadScreen extends StatefulWidget {
  static const String name = 'sustentabilidad_screen';
  const SustentabilidadScreen({super.key});
  @override
  State<SustentabilidadScreen> createState() => _SustentabilidadScreenState();
}

class _SustentabilidadScreenState extends State<SustentabilidadScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const _SustentabilidadView(),
...
class _SustentabilidadView extends ConsumerWidget {
  const _SustentabilidadView();
  @override
