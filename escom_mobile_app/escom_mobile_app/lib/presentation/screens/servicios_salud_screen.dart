...
class ServiciosSaludScreen extends StatefulWidget {
  static const String name = 'servicios_salud_screen';
  const ServiciosSaludScreen({super.key});
  @override
  State<ServiciosSaludScreen> createState() => _ServiciosSaludScreenState();
}

class _ServiciosSaludScreenState extends State<ServiciosSaludScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const _ServiciosSaludView(),
...
class _ServiciosSaludView extends ConsumerWidget {
  const _ServiciosSaludView();
  @override
